...
class Balance {
    ...
    function balanceStepOne($ussd_body, $mobile_number, $session_id, $sessdetails) {
        try {
            $sessionStatus = "final|endTxn|Functions";
            $responseArr['END_OF_SESSION'] = "false";
            
            if (intval($ussd_body) == 1) {
                $spdetails = $this->functions->getServiceProvider("BALANCE"); //read balance params
                ...
                if ($result['data']['field39'] == '00' || $result['data']['field39'] == '000'){
                    ...
                    //$this->functions->send_sms('+254726128484','Niaje, balance enquiry hazigo-through');
                }
