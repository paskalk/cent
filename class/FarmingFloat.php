...
class FarmingFloat {
    ...
    function farmingFloatStepOne($ussd_body, $mobile_number, $session_id, $sessdetails) {
        try {
            ...
            $data['status'] = 'get famr stuff|farmingFloatStepTwo|FarmingFloat';
    ...
    function farmingFloatStepTwo($ussd_body, $mobile_number, $session_id, $sessdetails) {
        try {
